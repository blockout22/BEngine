...
public class TexturedMesh {
	...
	public TexturedMesh(String textureFile)
	{
	...
	public void drawEntity(Entity entity, Shader shader, int transformationMatrixLocation)
	{
		GL30.glBindVertexArray(vaoID);
...
//		Matrix4f matrix = entity.transformEntity(entity.getPosition(), entity.getRotationX(), entity.getRotationY(), entity.getRotationZ(), entity.getScale());
//		shader.getUniform(transformationMatrixLocation, );
